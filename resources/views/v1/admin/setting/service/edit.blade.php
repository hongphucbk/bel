...
@endif
<form action="v1/admin/setting/service/edit/{{ $service->id }}" method="post">
  @csrf
  <div class="form-row">
    ...
    <div class="col-md-9 mb-3">
      ...
      <input type="text" class="form-control" name="description" placeholder="Description" value="{{ $service->description }}">
    </div>
    <div class="col-md-2 mb-3">
      <label>Icon</label>
      <input type="text" class="form-control" name="icon" placeholder="fas fa-gem" value="{{ $service->icon }}">
    </div>
    <div class="col-md-4 mb-3">
      <label>Note</label>
      <input type="text" class="form-control" name="note" placeholder="Note" value="{{ $service->note }}">
    </div>
