...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="v1/admin/news/content" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list fa-sm"></i> Content List</a>
</div>
@if(count($errors)>0)
...
@endif
<form action="v1/admin/news/content/add" method="post">
  @csrf
  <div class="form-row">
