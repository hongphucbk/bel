...
@section('menu2')
  @include('v1.member.doc.role.common.menu2')
@endsection
@section('content')
<div class="container-fluid">
  <div class="row">
    <div class="col">
      <form method="post" action="v1/member/doc/role">
        @csrf
      ...
      <table class="table table-sm" id="dtTable">
        ...
        <tbody>
          ...
          <tr class="odd">
            ...
            <td>
              <a href="v1/member/doc/role/display/{{ $val->id }}" class="tb1">
                <i class="far fa-eye"></i></a>
              <a href="v1/member/doc/role/edit/{{ $val->id }}" class="tb1">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/doc/role/display/{{ $val->id }}" class="menu">
                  ...
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/doc/role/edit/{{ $val->id }}" class="menu">
                      <i class="fas fa-edit" style=""></i>
                      Edit
                    </a>
                  </button>
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/doc/role/delete/{{ $val->id }}" class="menu">
