...
<div class="container-fluid">
  <div class="row">
    <div class="col">
      <form method="post" action="v1/member/warehouse/warehouse">
        @csrf
        <div class="form-group row">
          <label class="col-sm-1 col-form-label col-form-label-sm">Code</label>
          <div class="col-sm-2">
            <input type="text" class="form-control form-control-sm" name="code" value="{{ $oldData['warehouse_code']}}">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-1 col-form-label col-form-label-sm">Name</label>
          <div class="col-sm-2">
            <input type="text" class="form-control form-control-sm" name="name" value="{{ $oldData['warehouse_name']}}">
          </div>
        </div>
        <!-- <div class="form-group row">
      ...
      <table class="table table-sm" id="dtTable">
        <thead>
          <tr style="background-color:  #f5f5ef">
            ...
            <th scope="col" style="width: 20%">Facility</th>
        ...
        <tbody>
          ...
          <tr class="odd">
            ...
            <td>
              <a href="v1/member/warehouse/warehouse/display/{{ $val->id }}" class="tb1">
                <i class="far fa-eye"></i></a>
              <a href="v1/member/warehouse/warehouse/edit/{{ $val->id }}" class="tb1">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/warehouse/warehouse/display/{{ $val->id }}" class="menu">
                  ...
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/warehouse/warehouse/edit/{{ $val->id }}" class="menu">
                      <i class="fas fa-edit" style=""></i>
                      Edit
                    </a>
                  </button>
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/warehouse/warehouse/delete/{{ $val->id }}" class="menu">
