...
<div class="container-fluid">
  <div class="row">
    <div class="col">
      <form method="post" action="v1/member/warehouse/supplier">
        @csrf
      ...
      <table class="table table-sm" id="dtTable">
        ...
        <tbody>
          ...
          <tr class="odd">
            ...
            <td>{{ $val->code }}</td>
            <td>{{ $val->name }}</td>
            <td>{{ $val->tax_id_number }}</td>
            <td>{{ $val->contact_name }}</td>
            <td>{{ $val->phone }}</td>
            <td>
              <a href="v1/member/warehouse/supplier/display/{{ $val->id }}" class="tb1">
                <i class="far fa-eye"></i></a>
              <a href="v1/member/warehouse/supplier/edit/{{ $val->id }}" class="tb1">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/warehouse/supplier/display/{{ $val->id }}" class="menu">
                  ...
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/warehouse/supplier/edit/{{ $val->id }}" class="menu">
                      <i class="fas fa-edit" style=""></i>
                      Edit
                    </a>
                  </button>
                  <button class="dropdown-item" type="button">
                    <a href="v1/member/warehouse/supplier/delete/{{ $val->id }}" class="menu">
