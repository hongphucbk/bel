...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2020 at 10:07 AM
...
--
-- Database: `phuctruong_smartfactory`
--
...
--
-- Table structure for table `course_attach`
--
...
--
-- Table structure for table `course_content_type`
--
...
--
-- Dumping data for table `course_content_type`
--
...
--
-- Table structure for table `course_dislike`
--
...
--
-- Dumping data for table `course_dislike`
--
...
--
-- Table structure for table `course_exercise`
--
...
CREATE TABLE `doc_approval` (
  ...
  `is_backup` smallint(6) NOT NULL DEFAULT 0,
...
INSERT INTO `doc_approval` (`id`, `infor_id`, `approval_id`, `level`, `is_submit`, `comment`, `is_active`, `priority`, `is_backup`, `status`, `note`, `remind_date`, `user_id`, `created_at`, `updated_at`) VALUES
(22, 4, 3, 1, 1, 'ok', 1, 100, 0, 30, NULL, NULL, 3, '2020-10-17 08:27:13', '2020-10-17 08:39:38'),
(23, 4, 1, 2, 1, 'good', 1, 100, 0, 30, NULL, NULL, 1, '2020-10-17 08:27:21', '2020-10-17 08:43:10'),
(24, 4, 35, 0, 0, 'hihi', 1, 100, 0, 10, NULL, NULL, 35, '2020-10-17 08:27:42', '2020-10-17 08:36:07'),
(25, 5, 3, 1, 1, NULL, 1, 100, 0, 30, NULL, NULL, 1, '2020-10-17 09:51:27', '2020-10-17 10:01:30'),
(27, 5, 1, 2, 1, NULL, 1, 100, 0, 30, NULL, NULL, 1, '2020-10-17 09:51:43', '2020-10-17 10:03:52'),
(28, 5, 35, 0, 0, NULL, 1, 100, 1, 10, NULL, NULL, 1, '2020-10-17 09:52:26', '2020-10-17 09:52:26'),
(29, 6, 35, 2, 0, NULL, 1, 100, 0, 10, NULL, NULL, 35, '2020-10-21 16:39:00', '2020-10-21 16:39:00'),
(30, 6, 1, 0, 0, NULL, 1, 100, 1, 10, NULL, NULL, 35, '2020-10-21 16:39:10', '2020-10-21 16:39:10'),
(31, 6, 3, 1, 0, NULL, 1, 100, 0, 10, NULL, NULL, 35, '2020-10-21 16:40:09', '2020-10-21 16:40:09'),
(34, 7, 1, 1, 1, NULL, 1, 100, 0, 10, NULL, '2020-10-27 09:43:30', 35, '2020-10-22 16:11:16', '2020-10-25 02:43:30'),
(35, 8, 35, 1, 1, NULL, 1, 100, 0, 30, NULL, '2020-10-25 09:41:29', 35, '2020-10-22 16:24:39', '2020-10-25 08:48:20'),
(36, 8, 1, 2, 1, NULL, 1, 100, 0, 20, NULL, NULL, 35, '2020-10-22 16:26:29', '2020-10-25 08:56:12'),
(37, 7, 35, 2, 0, NULL, 1, 100, 0, 10, NULL, NULL, 35, '2020-10-25 02:43:05', '2020-10-25 02:43:05');
...
CREATE TABLE `doc_attach` (
  ...
  `extend` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `priority` int(10) UNSIGNED NOT NULL DEFAULT 100,
  `note` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `doc_attach`
--
...
(22, 1, 5, 'dada', 'upload/bel/document/2020_10', '20201017.165041.5_hotgirl-it-tung-ram-ro-mot-thoi7_20191023084018.jpg', NULL, '93.22 KB', 'jpg', 1, 100, NULL, '2020-10-17 09:50:41', '2020-10-17 09:50:41'),
(24, 1, 5, 'dadfads', 'upload/bel/document/2020_10', '20201017.165056.5_hin_irl-xinh-840x560-1-730x430.jpg', NULL, '52.21 KB', 'jpg', 1, 100, NULL, '2020-10-17 09:50:56', '2020-10-17 09:50:56'),
(25, 35, 6, 'gfsfsg', 'upload/bel/document/2020_10', '20201021.225651.6_hotgirl-it-tung-ram-ro-mot-thoi7_20191023084018.jpg', NULL, '93.22 KB', 'jpg', 1, 100, NULL, '2020-10-21 15:56:51', '2020-10-21 15:56:51'),
(26, 35, 7, 'dffaf', 'upload/bel/document/2020_10', '20201021.234030.7_-as_._p_12_--.jpg', NULL, '264.34 KB', 'jpg', 1, 100, NULL, '2020-10-21 16:40:30', '2020-10-21 16:40:30'),
(27, 35, 8, 'fad', 'upload/bel/document/2020_10', '20201022.232253.8_So do nguyen ly 002.png', NULL, '8.49 KB', 'png', 1, 100, NULL, '2020-10-22 16:22:53', '2020-10-22 16:22:53'),
(28, 35, 16, 'dS', 'upload/bel/document/2020_10', '20201025.100913.16_Ban ve PLC.jpg', NULL, '96.32 KB', 'jpg', 1, 100, NULL, '2020-10-25 03:09:13', '2020-10-25 03:09:13');

-- --------------------------------------------------------

--
-- Table structure for table `doc_flow`
--
...
--
-- Table structure for table `doc_infor`
--

CREATE TABLE `doc_infor` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `code` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(400) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level_max` int(10) UNSIGNED NOT NULL DEFAULT 2,
...
--
-- Dumping data for table `doc_infor`
--
...
(4, 35, 'PLC-001', 'Change request Setpoint Temp PLC', 'Change Temperature for PLC', 2, 7, 1, 100, NULL, '2020-10-16 12:30:12', '2020-10-21 15:40:32'),
(5, 1, 'adad', 'dfa', 'dafd', 2, 2, 1, 100, 'fada', '2020-10-17 09:50:27', '2020-10-17 09:50:27'),
(6, 35, 'ada', '123', '123', 2, 2, 1, 100, 'daf', '2020-10-21 15:46:19', '2020-10-21 15:46:19'),
(7, 35, 'adfad', 'fad', 'dadf', 2, 2, 1, 100, 'dad', '2020-10-21 15:46:44', '2020-10-21 15:46:44'),
(8, 35, 'ad', 'g', 'fad', 2, 2, 1, 100, 'afd', '2020-10-21 15:50:10', '2020-10-21 15:50:10'),
(9, 35, 'ad', 'g', 'fad', 2, 2, 1, 100, 'afd', '2020-10-21 15:50:15', '2020-10-21 15:50:15'),
(10, 35, NULL, 'g', 'fs', 2, 2, 1, 100, 'sf', '2020-10-21 15:53:37', '2020-10-21 15:53:37'),
(11, 35, NULL, 'fda', NULL, 2, 2, 1, 100, NULL, '2020-10-21 15:54:15', '2020-10-21 15:54:15'),
(12, 35, NULL, 'da', NULL, 2, 2, 1, 100, NULL, '2020-10-25 03:01:55', '2020-10-25 03:01:55'),
(13, 35, NULL, 'dada', NULL, 2, 2, 1, 100, NULL, '2020-10-25 03:01:58', '2020-10-25 03:01:58'),
(14, 35, NULL, 'dadfad', NULL, 2, 2, 1, 100, NULL, '2020-10-25 03:02:00', '2020-10-25 03:02:00'),
(15, 35, NULL, 'dadfad', NULL, 2, 2, 1, 100, NULL, '2020-10-25 03:02:02', '2020-10-25 03:02:02'),
(16, 35, NULL, 'dafadf', NULL, 2, 2, 1, 100, NULL, '2020-10-25 03:02:05', '2020-10-25 03:02:05');

-- --------------------------------------------------------

--
-- Table structure for table `doc_role`
--
...
--
-- Dumping data for table `doc_role`
--

INSERT INTO `doc_role` (`id`, `code`, `name`, `description`, `is_active`, `priority`, `note`, `created_at`, `updated_at`) VALUES
(1, '1', 'User', 'Operator, User who can raise documents', 1, 100, NULL, '2020-10-09 16:12:11', '2020-10-09 16:12:11'),
(2, '2', 'Level 1', 'Level 1', 1, 100, NULL, '2020-10-10 10:31:10', '2020-10-10 10:31:10'),
(3, '3', 'Level 2', 'Level 2 will aprove when level 1 done', 1, 100, NULL, '2020-10-10 10:31:31', '2020-10-17 08:10:31'),
(4, '4', 'admin', 'admin', 1, 100, NULL, '2020-10-10 10:31:40', '2020-10-17 08:09:55');

-- --------------------------------------------------------

--
-- Table structure for table `doc_role_user`
--

CREATE TABLE `doc_role_user` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `doc_role_user`
--
...
(5, 50, 'P > 1/2 Approved', 'All Approved', 1, 100, NULL, '2020-10-09 15:01:37', '2020-10-25 08:50:25'),
...
(10, 60, 'All Approved', NULL, 1, 100, NULL, '2020-10-25 08:49:13', '2020-10-25 08:49:13');

-- --------------------------------------------------------

--
-- Table structure for table `helpdesk_activity`
--
...
--
-- Dumping data for table `helpdesk_activity`
--
...
--
-- Table structure for table `helpdesk_attach`
--
...
(54, '2020_10_17_164020_add_new_column_backup_into_approval_table_20201017', 20),
(56, '2020_10_22_233018_add_user_is_active_20201022', 21);
...
--
-- Table structure for table `news_rate`
--
...
--
-- Table structure for table `soft_attach`
--
...
--
-- Dumping data for table `soft_attach`
--
...
--
-- Table structure for table `soft_content`
--
...
--
-- Dumping data for table `soft_content`
--
...
--
-- Table structure for table `soft_info`
--
...
--
-- Dumping data for table `soft_info`
--
...
--
-- Table structure for table `soft_rate`
--
...
INSERT INTO `users` (`id`, `name`, `phone`, `email`, `role`, `is_active`, `confirmation_code`, `avata`, `is_social`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'DHThuan', '0968460480', 'phuctruong@bluescope.com', 4, 1, NULL, NULL, 0, '2019-12-17 19:00:00', '$2y$10$tC6Zr/YRemtCfEW.UiDQ/e2dc5s5Plo31SjdorO8Kv8cqkljb.Vrm', NULL, NULL, '2020-10-17 08:41:45'),
(3, 'LT Hai', '123456', 'phuctruongdev@gmail.com', 4, 1, NULL, NULL, 0, '2020-10-15 12:54:15', '$2y$10$WCbsNA9/RLk0Qx4PCzoFBesFzgpubm9RgenKKXsvWHycKuh9A4kT2', NULL, '2019-12-29 18:05:50', '2020-10-16 12:55:29'),
(5, 'PTHa', '0986', 'phuchong943@gmail.com', 0, 1, NULL, NULL, 0, NULL, '$2y$10$TxTookz/fBqL96YVekwU8uRNhT8faBmIma/hFGUFoCD556UhSOq7u', NULL, '2019-12-31 09:32:36', '2020-10-16 12:40:23'),
(6, 'MDNThuan', '123456789', 'phuchong944@gmail.com', 1, 1, NULL, NULL, 0, NULL, '$2y$10$3r3V45NgUJw3I.PhZkCOB.yUjXsj8sEXhNDw4NZanGRSi7m/Z0oQO', NULL, '2020-01-01 17:05:46', '2020-10-16 12:40:36'),
(33, 'HTNhat', '0', 'nhat@gmail.com', 0, 1, NULL, 'https://s120.avatar.talk.zdn.vn/9/5/c/9/11/120/71dc71fcbea9a874cb1e94572ee33411.jpg', 1, NULL, '$2y$10$.cRiOAIJ7GXgBAuWKvIfTuJOPzDT2uAEI5qHKbpqpXmDQNARxtPoi', NULL, '2020-04-20 14:07:31', '2020-10-16 12:41:00'),
(34, 'DHMinh', '34', 'phuc.truong@bluescope.com1', 1, 1, NULL, NULL, 0, '2020-04-21 01:40:45', '$2y$10$7zjCWgAlzyzGzJsLQQHVxOxO/L2.KOZtor3/Ce9MXUl75hc/x8YFy', NULL, '2020-04-21 01:39:18', '2020-10-22 16:43:06'),
(35, 'HDHuy', '098123456', 'phuchong94@gmail.com', 4, 1, NULL, NULL, 0, '2020-10-15 12:25:11', '$2y$10$wE4ZV7nSmiFZw58nfuYmR.OPdPddDw7L9D8OjxJd52wR0o/BT3sem', NULL, '2020-10-16 12:23:54', '2020-10-17 08:37:39'),
(36, 'abc', '1232322', 'abc@gmail.com', 1, 1, NULL, NULL, 0, NULL, '$2y$10$Yd9ef5Gg01hG5IFLOyQJtOprSNnYW5pWjT8RU785DuEybm43FQvOa', NULL, '2020-10-17 07:08:00', '2020-10-17 07:58:47'),
(37, 'gsf', '1234', 'đa', 1, 1, NULL, NULL, 0, NULL, '$2y$10$.DjEFxeBoYBBg2oncR3weu2TK.Pxun2fUkGLzTSWYNrCzfWjgzkn.', NULL, '2020-10-17 07:33:26', '2020-10-17 07:57:09');
...
--
-- Table structure for table `wh_customer`
--
...
--
-- Table structure for table `wh_facility`
--
...
--
-- Dumping data for table `wh_facility`
--
...
--
-- Table structure for table `wh_good_issue`
--
...
--
-- Table structure for table `wh_good_receipt`
--
...
--
-- Table structure for table `wh_item`
--
...
--
-- Dumping data for table `wh_item`
--
...
--
-- Table structure for table `wh_project`
--
...
--
-- Table structure for table `wh_supplier`
--
...
--
-- Table structure for table `wh_warehouse_item`
--
...
--
-- Dumping data for table `wh_warehouse_item`
--
...
--
-- Indexes for table `course_attach`
--
...
--
-- Indexes for table `course_content_type`
--
...
--
-- Indexes for table `course_dislike`
--
...
--
-- Indexes for table `course_exercise`
--
...
--
-- Indexes for table `doc_approval`
--
ALTER TABLE `doc_approval`
  ADD PRIMARY KEY (`id`),
  ADD KEY `doc_approval_user_id_foreign` (`user_id`),
  ADD KEY `doc_approval_approval_id_foreign` (`approval_id`),
  ADD KEY `doc_approval_infor_id_foreign` (`infor_id`);
...
ALTER TABLE `doc_attach`
  ADD PRIMARY KEY (`id`),
  ADD KEY `doc_attach_user_id_foreign` (`user_id`),
  ADD KEY `doc_attach_infor_id_foreign` (`infor_id`);

--
-- Indexes for table `doc_flow`
--
ALTER TABLE `doc_flow`
  ADD PRIMARY KEY (`id`),
  ADD KEY `doc_flow_user_id_foreign` (`user_id`),
  ADD KEY `doc_flow_approval_id_foreign` (`approval_id`),
  ADD KEY `doc_flow_infor_id_foreign` (`infor_id`);

--
-- Indexes for table `doc_infor`
--
ALTER TABLE `doc_infor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `doc_infor_user_id_foreign` (`user_id`),
  ADD KEY `doc_infor_status_id_foreign` (`status_id`);

--
-- Indexes for table `doc_role`
--
ALTER TABLE `doc_role`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `doc_role_user`
--
ALTER TABLE `doc_role_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `doc_role_user_role_id_foreign` (`role_id`),
  ADD KEY `doc_role_user_user_id_foreign` (`user_id`);
...
--
-- Indexes for table `helpdesk_activity`
--
...
--
-- Indexes for table `helpdesk_attach`
--
...
--
-- Indexes for table `setting_service`
--
...
--
-- Indexes for table `soft_content`
--
...
--
-- Indexes for table `wh_facility`
--
ALTER TABLE `wh_facility`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wh_good_issue`
--
...
--
-- Indexes for table `wh_good_receipt`
--
...
--
-- Indexes for table `wh_warehouse_item`
--
...
--
-- AUTO_INCREMENT for table `course_activity`
--
ALTER TABLE `course_activity`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `course_attach`
--
ALTER TABLE `course_attach`
...
--
-- AUTO_INCREMENT for table `course_content_type`
--
ALTER TABLE `course_content_type`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `course_dislike`
--
ALTER TABLE `course_dislike`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `course_exercise`
--
ALTER TABLE `course_exercise`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `helpdesk_attach`
--
ALTER TABLE `helpdesk_attach`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `news_rate`
--
ALTER TABLE `news_rate`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `setting_service`
--
ALTER TABLE `setting_service`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `soft_attach`
--
ALTER TABLE `soft_attach`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `soft_content`
--
ALTER TABLE `soft_content`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `soft_info`
--
ALTER TABLE `soft_info`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `soft_rate`
--
ALTER TABLE `soft_rate`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `wh_customer`
--
ALTER TABLE `wh_customer`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wh_facility`
--
ALTER TABLE `wh_facility`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `wh_good_issue`
--
ALTER TABLE `wh_good_issue`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wh_good_receipt`
--
ALTER TABLE `wh_good_receipt`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wh_item`
--
ALTER TABLE `wh_item`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `wh_project`
--
ALTER TABLE `wh_project`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wh_supplier`
--
ALTER TABLE `wh_supplier`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `wh_warehouse_item`
--
ALTER TABLE `wh_warehouse_item`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Constraints for table `course_attach`
--
ALTER TABLE `course_attach`
...
--
-- Constraints for table `course_content_type`
--
ALTER TABLE `course_content_type`
...
--
-- Constraints for table `course_dislike`
--
ALTER TABLE `course_dislike`
...
--
-- Constraints for table `course_exercise`
--
ALTER TABLE `course_exercise`
...
--
-- Constraints for table `doc_approval`
--
ALTER TABLE `doc_approval`
  ADD CONSTRAINT `doc_approval_approval_id_foreign` FOREIGN KEY (`approval_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `doc_approval_infor_id_foreign` FOREIGN KEY (`infor_id`) REFERENCES `doc_infor` (`id`),
  ADD CONSTRAINT `doc_approval_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `doc_attach`
--
ALTER TABLE `doc_attach`
  ADD CONSTRAINT `doc_attach_infor_id_foreign` FOREIGN KEY (`infor_id`) REFERENCES `doc_infor` (`id`),
  ADD CONSTRAINT `doc_attach_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `doc_flow`
--
ALTER TABLE `doc_flow`
  ADD CONSTRAINT `doc_flow_approval_id_foreign` FOREIGN KEY (`approval_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `doc_flow_infor_id_foreign` FOREIGN KEY (`infor_id`) REFERENCES `doc_infor` (`id`),
  ADD CONSTRAINT `doc_flow_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `doc_infor`
--
ALTER TABLE `doc_infor`
  ADD CONSTRAINT `doc_infor_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `doc_status` (`id`),
  ADD CONSTRAINT `doc_infor_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `doc_role_user`
--
ALTER TABLE `doc_role_user`
  ADD CONSTRAINT `doc_role_user_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `doc_role` (`id`),
  ADD CONSTRAINT `doc_role_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `helpdesk_activity`
--
ALTER TABLE `helpdesk_activity`
...
--
-- Constraints for table `helpdesk_attach`
--
ALTER TABLE `helpdesk_attach`
...
--
-- Constraints for table `news_rate`
--
ALTER TABLE `news_rate`
...
--
-- Constraints for table `soft_attach`
--
ALTER TABLE `soft_attach`
...
--
-- Constraints for table `soft_content`
--
ALTER TABLE `soft_content`
...
--
-- Constraints for table `wh_good_receipt`
--
ALTER TABLE `wh_good_receipt`
...
--
-- Constraints for table `wh_project`
--
ALTER TABLE `wh_project`
