...
use App\Repositories\Soft\Content\ContentRepositoryInterface;
...
class ContentController extends Controller
{
    ...
    public function getList()
    {
        ...
        return view('v1.admin.soft.content.list', compact('contents'));
    }

    public function getAdd()
    {
      $infos = Info::all();
      return view('v1.admin.soft.content.add', compact('infos'));
    }
    ...
    public function getEdit($id)
    {
      ...
      $infos = Info::all();
      return view('v1.admin.soft.content.edit', compact('content', 'infos'));
    }
